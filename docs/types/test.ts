...
// The function returns a complex number...
{
	...
	scale( 5.0, z ); // $ExpectType Complex128
}
...
{
	scale.assign( 5.0, 1.0, 1.0, new Float64Array( 2 ), 1, 0 ); // $ExpectType Float64Array
...
// Attached to the main export is a `strided` method which returns a collection...
{
	...
	scale.strided( 5.0, z1, 1, 0, new Float64Array( 2 ), 1, 0 ); // $ExpectType Float64Array
